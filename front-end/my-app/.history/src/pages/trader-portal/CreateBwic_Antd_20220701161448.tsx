...
const CreateBwic_Antd: React.FC = () => {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center" }}>
            <div className="aaa" style={{ width: "1500px" }}>
                <h1 className="h1">Create BWIC</h1>
                <Form<BwicItems> labelCol={{ span: 8 }} wrapperCol={{ span: 16 }} onFinish={onFinish} initialValues={initateBwic}>
                    <Form.Item color label="Cusip" name="cusip" rules={[{ required: true, message: 'Please input CUSIP!', }]} >
                    ...
                    {<Form.Item label="Due Date" name="duedate" >
                        <Input style={{width:"400px"}} prefix={<ClockCircleOutlined />} placeholder="YYYY-MM-DD HH:mm:ss"/> 
                    {/* <DatePicker
              showTime
