...
const BwicPage: React.FC = () => {  
  ...
  const getColumnSearchProps = (dataIndex:BwicItems): ColumnType<BwicItems> => ({
    filterDropdown: ({ setSelectedKeys, selectedKeys, confirm, clearFilters }) => (
      <div style={{ padding: 8 }}>
        <Input
          ...
          onPressEnter={() => handleSearch(selectedKeys as string[], confirm, BwicItems)}
